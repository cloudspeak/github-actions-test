...
* _Update the `github_actions_test/new_res` folder by implementing the NewRes resource and provider_
* _Update the `test/new_res` folder with unit tests for your resource_
...
│   ├── new_res                             The folder for a particular resource type
│   │   ├── new_res_provider.py             The Pulumi resource object
│   │   └── new_res.py                      The Dynamic Provider for the resource
