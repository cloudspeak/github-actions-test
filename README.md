...
* _Update the `github_actions_test/any_resource` folder by implementing the AnyResource resource and provider_
* _Update the `test/any_resource` folder with unit tests for your resource_
...
│   ├── any_resource                        The folder for a particular resource type
│   │   ├── any_resource_provider.py        The Pulumi resource object
│   │   └── any_resource.py                 The Dynamic Provider for the resource
