...
from .anyoldresource_provider import AnyoldresourceProvider


class Anyoldresource(Resource):
    """
    A Anyoldresource resource.
    ...
    def __init__(
        ...
        super().__init__(
            provider=AnyoldresourceProvider(provider),
            name=resource_name,
